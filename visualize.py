...
class YoloVisualizer:
    MODE_TRAIN = 0
    MODE_VAL = 1
    dataset_folder = Path("C:/Users/Siddhant/downloads/hackathon_dataset/hackbyte_dataset")
...
if __name__ == "__main__":
    vis = YoloVisualizer("C:/Users/Siddhant/downloads/hackathon_dataset/hackbyte_dataset/data")
    vis.run()
